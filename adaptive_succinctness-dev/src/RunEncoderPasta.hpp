...
public:
  ...
  _rank_select rank_select_tchuff_r0;

  _bv tc_or_huffman_r1;
  _rank_select rank_select_tchuff_r1;

  _bv block_r1;
  _rank_select rank_select_block_r1;

  _bv block_r0;
  _rank_select rank_select_block_r0;
  ...
  RunEncoderPasta(sdsl::bit_vector &bv, uint64_t top_k);
  RunEncoderPasta(std::vector<uint64_t> &pb, uint64_t top_k);
