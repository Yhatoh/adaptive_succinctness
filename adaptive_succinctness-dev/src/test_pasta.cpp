...
typedef RunEncoderPasta<16, 256, 523776, pasta::BitVector, pasta::FlatRankSelect<>> res_256_sd;
typedef RunEncoderPasta<16, 512, 523776, pasta::BitVector, pasta::FlatRankSelect<>> res_512_sd;
typedef RunEncoderPasta<16, 1024, 523776, pasta::BitVector, pasta::FlatRankSelect<>> res_1024_sd;
...
int main() {
  ...
  std::vector< uint64_t > ks = {8};//{8, 16, 32, 64};
  {
    for(uint64_t k : ks) {
      cout << "TEST BV 256 " << k << "\n"; 
